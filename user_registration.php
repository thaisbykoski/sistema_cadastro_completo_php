    ...
    <body>
        ...
        <div class="container registration">
            <div style="padding:10px;">
                ...
                <div class="buttons">
                    <a href="home.php" role="button" class="btn btn-sm btn-primary" style="width:8vw; font-size: 1rem"> Voltar </a>
                </div>
                <center>
                    <img src="img/user.png" alt="" width="125px" height="125px">
                </center>
                <div class="card-body">
                    <form action="user_crud_functions/_insert_user.php" method="POST">
