<?php
    ...
    $sql = "UPDATE `employees` SET `name`='$name',`email`='$email', `role`='$role', `department`='$department' WHERE id_employee = $id";
        ...
        <div class="container mb-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 pl-0 pr-0 border border-dark border-5 rounded-top">
                    <div class="card text-center del-conf border-success border-5">
                    <img class="card-img-top img-ok rounded float-left" src="../img/ok.png" alt="Imagem de capa do card">
                        <div class="card-body">
                            <h5 class="card-title border-0" style="margin-bottom: 18px; font-size:2rem;">Atualizado com sucesso!</h5>
