...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container mb-3">
            ...
            <div class="row">
                <!-- Hello Card -->
                <div class="col-sm-12 pl-0 pr-0 border border-dark border-5 rounded-top" style="background-color: #FFF;">
                    <div class="card text-center" style="margin:10rem;">
                        <img class="card-img-top img-welcome rounded float-left" src="img/welcome.png" alt="Imagem de capa do card">
                    </div>
                </div>
            </div>
        </div>
