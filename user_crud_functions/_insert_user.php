<?php
    ...
    $sql = "INSERT INTO users ( user_name, user_mail, user_password, user_level, status) VALUES ('$username','$mail',sha1('$password'),$level,'$status')";
            ...
            <div class="row">
                ...
                <div class="col-sm-12 pl-0 pr-0 border border-dark border-5 rounded-top">
                    <div class="card text-center del-conf border-success h-50">
                        ...
                        <div class="card-body">
                            <h5 class="card-title border-0" style="margin-bottom: 10px;">Usuário Cadastrado com Sucesso!</h5>
                            <div class="return-button">
                                <a href="../user_registration.php" role="button" class="btn btn-lg btn-primary"> Cadastrar novo Usuário </a>
                            </div>
                        </div>
                    </div>
                </div>
